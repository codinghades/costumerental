Public Class female
    ...
    Private Sub btnAnya_Click(sender As Object, e As EventArgs) Handles btnAnya.Click, btnStellar.Click, btnKanroji.Click, btnRaven.Click, btnHatsune.Click, btnNikke.Click
        ...
        Select Case btn.Name
            Case "btnAnya"
                costumeName = "Anya Spy x Family"
                dailyPrice = 2600
            Case "btnKanroji"
                costumeName = "Kanroji Demon Slayer"
                dailyPrice = 2100
            Case "btnHatsune"
                costumeName = "Hatsune Miku"
                dailyPrice = 1500
            Case "btnRaven"
                costumeName = "Raven Queen"
                dailyPrice = 1800
            Case "btnStellar"
                costumeName = "Stellar Blade"
                dailyPrice = 2200
            Case "btnNikke"
                costumeName = "Nikke Red Hood"
                dailyPrice = 2700
        End Select
    ...
    Private Sub btnReturn_Click(sender As Object, e As EventArgs) Handles btnReturn.Click
        ...
        For Each rental In rentalsList
            If rental.Contains("Anya Spy x Family") Then
                dailyPrices.Add(2600)
            ElseIf rental.Contains("Kanroji Demon Slayer") Then
                dailyPrices.Add(2100)
            ElseIf rental.Contains("Hatsune Miku") Then
                dailyPrices.Add(1500)
            ElseIf rental.Contains("Raven Queen") Then
                dailyPrices.Add(1800)
            ElseIf rental.Contains("Stellar Blade") Then
                dailyPrices.Add(2200)
            ElseIf rental.Contains("Nikke Red Hood") Then
